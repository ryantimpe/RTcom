...
The goal is to use the visitors in the **yellow box** to understand the behavior of the visitors in the **light blue** box, the museum guests who interact with the exhibits using their smartphones and social media. We won't have enough information to understand the behavior of visitors in the darker blue box.
